...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function () {
    ...
    Route::get('produkturunan', \App\Http\Livewire\ProdukTurunan\ProdukTurunanComponent::class)->name('produkturunan');
    ...
    Route::get('laporanstokmaterialtanggal/{tgl_awal}/{tgl_akhir}', [LaporanPersediaanController::class,'laporanstokmaterialtanggal'])->name('laporanstokmaterialtanggal');
    Route::get('laporanstokprodukturunantanggal/{tgl_awal}/{tgl_akhir}', [LaporanPersediaanController::class,'laporanstokprodukturunantanggal'])->name('laporanstokprodukturunantanggal');
    ...
    Route::get('laporanstokopname/{tgl_awal}/{tgl_akhir}/{barang_id}', [LaporanPersediaanController::class,'laporanstokopname'])->name('laporanstokopname');
