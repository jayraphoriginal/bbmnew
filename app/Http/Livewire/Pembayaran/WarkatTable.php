...
final class WarkatTable extends PowerGridComponent
{
    use ActionButton;
    ...
    *
    * @return  \Illuminate\Database\Eloquent\Builder<\App\Models\Pembayaran>|null
    */
...
;
    ...
    */
     ...
     /**
     * PowerGrid Pembayaran Action Buttons.
     *
    ...
    public function actions(): array
    {
       return [
            ...
            ->openModal('pembayaran.pencairan-warkat-keluar',[
                'pembayaran_id' => 'id'
            ]),
        ];
    }
    ...
    */
     ...
     /**
     * PowerGrid Pembayaran Action Rules.
     *
    ...
    public function actionRules(): array
    {
       return [
           ...
           ->when(fn(VPembayaran $model) => $model->status == 'finish')
           ->hide(),
        ];
    }
*/
    ...
    */
    ...
    {
       try {
           $updated = Pembayaran::query()->findOrFail($data['id'])
                ->update([
