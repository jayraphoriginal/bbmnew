<html>
    ...
    <body style="padding:2em">
        ...
        <div style="display:inline-block;margin-right:8px;">
            <input type="checkbox">
            <label>CEK/GIRO No.</label>
        </div>
        <div style="float:right;display:inline-block">TGL {{ date_create($data->tgl_penerimaan)->format('d F Y')}}</div>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td style="padding-left:8px;">Tgl, {{ date_create($data->tgl_penerimaan)->format('d F Y')}}</td>
            </tr>
            <tr>
