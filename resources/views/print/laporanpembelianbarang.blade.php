        ...
        <table class="mytable" style="width:100%">
            ...
            <tr>
                ...
                @php
                    ...
                    $totaldpp=$totaldpp+($item->jumlah*($item->harga/(1+ ($item->pajak/100))));
                    $totalppn=$totalppn+($item->jumlah*($item->harga - ($item->harga/(1+ ($item->pajak/100)))));
                    $totaljumlah=$totaljumlah+$item->jumlah;
                @endphp
            @endforeach 
            <tr>
                <td colspan="6" style="font-weight:bold">Total</td>
                <td class="text-right" style="font-weight:bold">{{ number_format($totaljumlah,2,',','.') }}</td>
                <td></td>
