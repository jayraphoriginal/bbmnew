<html>
    ...
    <body>
        ...
        @if (count($data) > 0)
        <p style="margin-bottom: 3rem;text-align:center; font-size:13px;">Periode : {{ date_format(date_create($tgl),'d/M/Y') }}</p>
            ...
            <div style="float:left;width:60%;">
                ...
                @foreach($datacustomer as $customer)
                    <tr>
                        ...
                        <td class="text-right">{{ number_format($customer->total,2,',','.').' '.$customer->satuan }}</td>
                    </tr>
                    @php
